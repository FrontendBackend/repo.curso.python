...
def saludo_inicial():
    ...
    # decir el saludo
    hablar(f'{momento}, soy Helena, tu asistente personal. Por favor, dime en qué te puedo ayudar causita!!!')
...
def pedir_cosas():
    ...
    while comenzar:
        ...
        if 'abrir youtube' in pedido:
            ...
            hablar("Me voy a descansar, cualquier cosa me avisas causa!!")
            break
